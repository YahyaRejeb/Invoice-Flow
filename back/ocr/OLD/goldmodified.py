...
def parse_steg_bill(gray_full, texts, hints=None, color_full=None):
    ...
    net_target, net_target_agreement, _ = read_amount_row_targeted(
        gray_full,  (0.93, 0.985),   # bottom-right footer, Y
(0.75, 0.975) 
    )
...
def process_uploaded_file(uploaded_file, hints=None):
    ...
    # Convert to canonical US Letter canvas (2550 x 3300 px @ 300 DPI) per specification
    from ocr_service import convert_to_us_letter_adobe
